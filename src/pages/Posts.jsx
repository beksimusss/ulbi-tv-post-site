...
function Posts() {
    ...
    return (
        <div className="App">
            ...
            />
            {postError &&
            <h1>Fatal error ${postError}</h1>
            }
            <PostList remove={removePost} posts={sortedAndSearchedPost} title="Posts List JS"/>
            <div ref={lastElement} style={{height: 15, background: 'withe'}}/>
            {isPostLoading &&
